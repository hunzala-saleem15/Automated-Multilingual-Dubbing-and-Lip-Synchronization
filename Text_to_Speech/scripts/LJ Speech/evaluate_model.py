...
# -----------------------------------------------------------------------------
# 1. PATHS SETUP (Updated for English Model)
# -----------------------------------------------------------------------------
# Aapki latest training directory
...
# Note: Agar 'best_model.pth' na mile to folder mein dekh lein ke numbered file (e.g., best_model_76806.pth) ka kya naam hai
MODEL_PATH = os.path.join(TRAIN_DIR, "best_model.pth") 

VOCAB_PATH = r"E:\TTS\TTS\checkpoints\XTTS_v2\vocab.json"
REF_AUDIO_PATH = r"E:\TTS\TTS\data\wavs\1034_121119_000010_000004.wav"

RESULTS_FILE = "evaluation_results.csv"

# Updated Sentences to English
test_sentences = [
    "Hello, this is a test to calculate the word error rate.",
    "Artificial intelligence is changing the world rapidly.",
    "I hope this experiment works correctly for my research.",
...
for idx, text in enumerate(test_sentences):
    ...
    # 2. Calculate WER
    # Changed language to "en"
    transcription_result = asr_model.transcribe(out_wav_path, language="en")
    transcribed_text = transcription_result["text"]
    
    # Basic cleaning for WER calculation
    error_rate = wer(text.lower(), transcribed_text.lower().strip())
